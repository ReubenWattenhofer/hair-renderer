			...
			Pass
			{
				...
				*/
				...
				/*	float z = (-shadowLightSpace.z - _DepthCameraPlanes.x) 
					...
					float depthValue;// = z - lightDepth;// -lightDepth;// -lightDepth;
					//float3 depthValue = float3(0,0,0);

					// layer 1
					if (z - _Layer1Thickness < culledDepth)
					{
						depthValue = lerp(0, lightDepth.g, (z - culledDepth) / _Layer1Thickness);
						//depthValue.r = lerp(0, lightDepth.g, (z - culledDepth) / _Layer1Thickness);
					}
					// layer 2
					else if (z - _Layer1Thickness - _Layer2Thickness < culledDepth)
					{
						depthValue = lerp(lightDepth.g, lightDepth.b, (z - _Layer1Thickness - culledDepth) / _Layer2Thickness);
						//depthValue.g = lerp(lightDepth.g, lightDepth.b, (z - _Layer1Thickness - culledDepth) / _Layer2Thickness);
						//depthValue.r = 1 - depthValue.g;
					}
					// layer 3
					else
					{
						depthValue = lerp(lightDepth.b, lightDepth.a,
							(z - _Layer1Thickness - _Layer2Thickness - culledDepth) / _Layer3Thickness);
					/*	depthValue.b = lerp(lightDepth.b, lightDepth.a,
							(z - _Layer1Thickness - _Layer2Thickness - culledDepth) / _Layer3Thickness);*/
						//depthValue.g = 1 - depthValue.b;
					}
